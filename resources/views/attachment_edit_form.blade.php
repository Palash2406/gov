                ...
                <div class="card-body badge-light">
                 @if($form_type=='link')
                        ...
                        <form  action="{{route('link.update',$link)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1" name="hyperlink" placeholder="http://www.something.com" value="{{$link->hyperlink}}">

                                <input type="text" name="type" value="{{$form_type}}"  hidden>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput2">Text for display</label>
                                <input type="text" class="form-control" id="exampleFormControlInput2" name="text_for_display" placeholder="title" value="{{$link->text_to_display}}">
                            </div>
                 ...
                 @elseif($form_type=='file')
                        ...
                        <form action="{{route('file.update',$file)}}" method="post" enctype="multipart/form-data">
                            ...
                            {{ method_field('PATCH') }}
                                ...
                                <label  >Old file:<a href="../../{{$file->path}}" target="_blank">{{$file->name}}</a></label>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" id="exampleFormControlInput2" value="{{$file->title}}" placeholder="title">
                            </div>
                            <button type="submit" class="btn btn-success mb-2">Submit</button>
                        </form>
                 ...
                 @elseif($form_type=='page')
                        ...
                        <form action="{{route('page.update',$page)}}" method="post">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput2">Title</label>
                                <input type="text" class="form-control"  id="exampleFormControlInput2" name="title" placeholder="title" value="{{$page['title']}}">
                                <input type="text" name="type" value="{{$form_type}}"  hidden>
                            </div>
                            <div class="form-group">
                                <label for="mytextarea">Body</label>
                                <textarea name="body" class="form-control " id="mytextarea">{!! $page['body'] !!}</textarea>
                            </div>
                            <button type="submit" class="btn btn-success mb-2">Submit</button>
                        </form>
