<?php /* C:\xampp\htdocs\gov\resources\views/slider/create.blade.php */ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo e(route('slider.store')); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput1" name="title" placeholder="Title" required value="<?php echo e(old('title')); ?>">
    </div>
    <div class="form-group">
        <label for="exampleFormControlFile1"></label>
        <input type="file" class="form-control-file" id="exampleFormControlFile1" name="file" value="<?php echo e(old('file')); ?>" required>
    </div>
