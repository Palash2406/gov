<?php /* C:\xampp\htdocs\gov\resources\views/attachment_edit_form.blade.php */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <div class="row mt-3">
        <div class="col">
            <div class="card">
                <h5 class="card-header "   style="background-color: #5c965c; color: white;">Edit</h5>
                <div class="card-body badge-light">
                 <?php if($form_type=='link'): ?>



                        <form  action="<?php echo e(route('link.update',$link)); ?>" method="post">
                            <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1" name="hyperlink" placeholder="http://www.something.com" value="<?php echo e($link->hyperlink); ?>">

                                <input type="text" name="type" value="<?php echo e($form_type); ?>"  hidden>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput2">Text for display</label>
                                <input type="text" class="form-control" id="exampleFormControlInput2" name="text_for_display" placeholder="title" value="<?php echo e($link->text_to_display); ?>">
                            </div>
                 ...
                 <?php elseif($form_type=='file'): ?>
                        ...
                        <form action="<?php echo e(route('file.update',$file)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

                            <?php echo e(method_field('PATCH')); ?>


                                <label  >Old file:<a href="../../<?php echo e($file->path); ?>" target="_blank"><?php echo e($file->name); ?></a></label>
                            <div class="form-group">

                                <label for="exampleFormControlFile1">Replace old file with Image or PDF</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" id="exampleFormControlInput2" value="<?php echo e($file->title); ?>" placeholder="title">
                            </div>
                            <button type="submit" class="btn btn-success mb-2">Submit</button>
                        </form>
                 ...
                 <?php elseif($form_type=='page'): ?>
                        ...
                        <form action="<?php echo e(route('page.update',$page)); ?>" method="post">
                            <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput2">Title</label>
                                <input type="text" class="form-control"  id="exampleFormControlInput2" name="title" placeholder="title" value="<?php echo e($page['title']); ?>">
                                <input type="text" name="type" value="<?php echo e($form_type); ?>"  hidden>
                            </div>
                            <div class="form-group">
                                <label for="mytextarea">Body</label>
                                <textarea name="body" class="form-control " id="mytextarea"><?php echo $page['body']; ?></textarea>
                            </div>
                            <button type="submit" class="btn btn-success mb-2">Submit</button>
                        </form>
